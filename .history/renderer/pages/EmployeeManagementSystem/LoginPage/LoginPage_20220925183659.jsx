...
import BigButton from '../../../src/components/EmployeeManagementSystem/Shared/Buttons/BigButton/BigButton';
import styles from './LoginPage.module.scss';
import Rest from '../../rest/Rest.tsx';
import { useUser, useUserUpdate } from '../../../src/components/contexts/UserContext';
...
export default function LoginPage() {
    ...
    const successfulLoginAdmin = (employee) => {
      ...
      router.replace("/pages/EmployeeManagementSystem/AttendancePage/AttendancePage");
    };
    const successfulLoginEmployee = (employee) => {
      ...
      router.replace("/pages/EmployeeManagementSystem/HomePage/HomePage");
    };
