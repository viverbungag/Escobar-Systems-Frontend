        ...
        <div className={styles.menu}>
            <ul>
                <li className={styles.home}>
                    <Link 
                    href='/pages/EmployeeManagementSystem/HomePage/HomePage'>
                ...
                <li>
                    ...
                    <Link 
                    href='/pages/EmployeeManagementSystem/EmployeeAttendancePage/EmployeeAttendancePage'>
                ...
                <li>
                    ...
                    <Link 
                    href='/pages/EmployeeManagementSystem/EmployeeAccountPage/EmployeeAccountPage'>
