...
export default function AddAccountModal({ addSuccessAction, activeEmployees }) {
  ...
  const [newAccount, setNewAccount] = useState(
    new Account(1, "", "", "", false, false, false, false, true)
  );
  ...
  const checkConfirmPassword = () => {
    if (
      confirmPassword == newAccount.accountPassword &&
      newAccount.accountPassword != ""
    ) {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.header}>Add Employee Account</div>
      <div className={styles.content_outer}>
        <div className={styles.content_inner}>
          <div className={styles.content_inner_left}>
            <div className={styles.content_inner_label}>Personal Details</div>
          ...
          <div className={styles.content_inner_right}>
            <div className={styles.content_inner_label}>Accessible Systems</div>
