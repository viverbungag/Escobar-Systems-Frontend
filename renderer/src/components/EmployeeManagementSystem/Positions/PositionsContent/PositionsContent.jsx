...
export default function PositionsContent() {
  ...
  const requestSearch = (searchValue) => {
    const filteredRows = positions.filter((row) => {
      return String(row.employeePositionName)
        .toLowerCase()
      ...
      <div className={styles.content}>
        ...
        <div className={styles.tables}>
          <div className={styles.active_table}>
            <div className={styles.header}>
              <div className={styles.left}>Active Positions</div>
      ...
      <Modal open={openEditModal} onClose={handleCloseEditModal}>
        <div className={styles.modal}>
          <EditPositionModal
            ...
            employeePositionId={selectedValues.map(
              (item) => item.employeePositionId
            )}
            employeePositionName={selectedValues.map(
              (item) => item.employeePositionName
            )}
