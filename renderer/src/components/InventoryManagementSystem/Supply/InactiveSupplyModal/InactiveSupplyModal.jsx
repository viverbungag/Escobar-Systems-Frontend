...
import styles from "./InactiveSupplyModal.module.scss";
  ...
  return (
    ...
    >
      <Slide
        ...
        unmountOnExit
      >
        <div className={styles["inactive-supply-modal"]}>
          <div className={styles["inactive-supply-modal__content"]}>
            <DataTable
              headers={headers}
              rows={rows}
              sortOrder={sortOrder}
...
export default InactiveSupplyModal;
