...
import styles from "./InactiveMenuModal.module.scss";
  ...
  return (
    ...
    >
      <Slide
        ...
        unmountOnExit
      >
        <div className={styles["inactive-menu-modal"]}>
          <div className={styles["inactive-menu-modal__content"]}>
            <DataTable
              headers={headers}
              rows={rows}
              sortOrder={sortOrder}
...
export default InactiveMenuModal;
